...
const Slider = () => {
    ...
    const slideIndexes = Array.from({ length: visibleSlides }, (_, i) => getAdjacentIndex(i - Math.floor(visibleSlides / 2)));
        ...
        <div className={s.slider}>
            ...
            {slideIndexes.map(index => (
                <div className={s.information} key={index}>
                    <img src={servers[index].image} className={s.server} alt={servers[index].version} />
